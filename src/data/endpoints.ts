...
// Concrete identifiers captured during reverse-engineering — account/community
// IDs, emails, device serials + signatures, HealthKit tokens, and capture
// timestamps — are templated to {id} / {userId} / {email} / {strapSerial} /
// {strapSignature} / {token} / {code} / {timestamp}. The generator MUST keep
// doing this; never ship a real identifier.
export const ENDPOINTS: readonly string[] = [
  ...
  "GET 200 /membership-service/v0/onboarding/info?flow=create-account&strapSerial={strapSerial}&strapSignature={strapSignature}",
  ...
  "GET 200 /onboarding-service/v1/account/start?email={email}&fromLogin=false",
  ...
  "GET 404 /coaching-service/v1/performance-assessment/MONTH/data/{timestamp}",
  ...
  "GET 404 /membership-service/v2/straps/pairing-adjustment?strapSerial={strapSerial}&strapSignature={strapSignature}",
  ...
  "POST 200 /community-service/v1/communities/join/COMM-{code}",
